...
describe LogStash::Outputs::Keystone::KeystoneClient do
  ...
  describe "#authenticate" do
    ...
    it "authenticates user successfully" do
      ...
      @keystone_client.authenticate('1051bd27b9394120b26d8b08847325c0', '06ecc9869b8e4846b2fce3e5759ba4af', 'password').should == LogStash::Outputs::Keystone::Token.new('f8cdafb7dce94444ad781a53ddaff693', DateTime.parse("2015-05-26T08:55:36.774122Z"))
    end
    ...
    it "authenticates user with false credentials" do
      ...
      @keystone_client.authenticate('1051bd27b9394120b26d8b08847325c0', '06ecc9869b8e4846b2fce3e5759ba4af', 'password').should == LogStash::Outputs::Keystone::Token.new(nil, nil)
    end
  end
